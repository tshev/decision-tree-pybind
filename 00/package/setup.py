...
disciple_src_files = [str(x) for x in os.listdir(CPP_SRC)]
disciple_src_cc = [str(os.path.join(CPP_SRC, x)) for x in disciple_src_files if x.endswith(".cc")]

ext_modules = [
    Extension(
        str("disciple_pybind"),
        [str("python/disciple_module/disciple/pybind/disciple_pybind.cc"),] + disciple_src_cc,
...
setup(
    ...
    description="disciple Python bindings",
    ...
    package_dir={str(""): str(os.path.join("python", "disciple_module"))},
    zip_safe=False,
)
